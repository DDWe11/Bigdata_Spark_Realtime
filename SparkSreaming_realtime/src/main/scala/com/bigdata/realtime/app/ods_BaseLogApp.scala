...
import com.bigdata.realtime.util.{MyKafkaUtils, MyOffsetsUtils}
            ...
            for (jsonObj <- jsonObjIter) {
              ...
              if (errObj != null) {
                ...
                if (pageObj != null) {
                  ...
                  //封装成PageLog
                  val pageLog: PageLog = PageLog(mid, uid, ar, ch, isNew, md, os, vc, ba,
                ...
                if (startJsonObj != null) {
                  ...
                  val startLog: StartLog = StartLog(mid, uid, ar, ch, isNew, md, os, vc, ba,
                                              entry, openAdId, loadingtime, openAdMs,
                                              openAdSkipMs, ts)
